...
/**
 * @author xuekun
 * @create 2020-06-03 10:19
 */
public class RankSkipListNode implements Comparable<RankSkipListNode> {
  private int rank;
  private SkipListNode skipListNode;
  ...
  public SkipListNode getSkipListNode() {
    return skipListNode;
  }

  public void setSkipListNode(SkipListNode skipListNode) {
   ...
   */
  @Override
  public int compareTo(RankSkipListNode o) {
    if (this.rank < o.rank) {
      return -1;
